					...
					<div class="page_right">
						<div  class="pagetitlebis">
							<div class="pagetitletext">
								...
								<h1 class="titre">Add a user</h1>
								<h2 class="description">Please fill out the form below to add a driver to <span class="safecare">Safecare</span>>'s web site.</h2>
						...
						<form name="inscription_utilisateur" enctype="multipart/form-data" method="post" action="../controller/controller_inscription_en.php" onsubmit="return inscriptionValidation('utilisateur','anglais','driver')">
							<p>
							
								<input onkeyup="erreurPrenom('utilisateur','anglais')" id="prenom" type="text" name="prenom" placeholder="First name*" class="formulaire" id="prenom" required/>
									
								<input onkeyup="erreurNom('utilisateur','anglais')" id="nom" type="text" name="nom" placeholder="Last name*" class="formulaire" id="nom" required />
								<span class="error" id="error_prenom"></span>
								<span class="error" id="error_nom"></span>
								</br>
								<input onkeyup="erreurBirthday('utilisateur','anglais')" id="birthday" type="text" class="formulaire"  name="birthday" placeholder="Birthday (yyyy-mm-dd)*" id="birthday" required/>
								<input onkeyup="erreurEntreprise('utilisateur','anglais')" id="entreprise" type="text" name="entreprise" placeholder="Company*" class="formulaire" id="entreprise" required />
								<span class="error" id="error_birthday"></span>
								<span class="error" id="error_entreprise"></span>
								</br>
								
								<input onkeyup="erreurEmail('utilisateur','anglais')" id="email" type="email" name="email" placeholder="Email*" class="formulaire" id="email" required />
								<input onkeyup="erreurEmail('utilisateur','anglais')" id="emailbis" type="email" name="emailbis" placeholder="Confirm email*" class="formulaire" id="emailbis" required />
								<span class="error" id="error_email"></span>
								<span class="error" id="error_emailbis"></span>
								</br>
								<input onkeyup="erreurPassword('utilisateur','anglais')" id="mdp" type="password" name="mdp" placeholder="Password**" class="formulaire" id="mdp" required />
								<input onkeyup="erreurPassword('utilisateur','anglais')" id="mdpbis" type="password" name="mdpbis" placeholder="Confirm password*" class="formulaire" id="mdpbis" required />
								</br>
