...
<html>
  <head>
    ...
    <title>Gestionnaire recherché</title>
  </head>
        ...
        <div id="page_principale">
          ...
          <div  class="pagetitle">
            ...
            <div class="pagetitletext">
              ...
              <h6>Retrouvez ici l'ensemble de ses informations</h6>
            </div>
            ...
            <div class="Informations">
                    ...
                    <h2> Prénom : <span class=profil_info ><?php echo $prenomG ?> </span></h2> 
                    
                    <h2> Nom : <span class=profil_info ><?php echo $nomG ?></span></h2> 
                    
                    <h2> Date de naissance : <span class=profil_info ><?php echo $birthdayG ?></span> </h2> 
                    
                    <h2> Nom de l'entreprise : <span class=profil_info ><?php echo $entrepriseG ?> </span></h2> 
