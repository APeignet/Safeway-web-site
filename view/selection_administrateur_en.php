      ...
      <div id="menu">
        ...
        <!-- Liens de navigation -->
            ...
            <div class="bas-menu">
                ...
                <a href="../controller/controller_cgu_fr.php">GTU</a>
            </div>
        ...
        <div id="page_principale">
          ...
          <header id="menu_haut">
            ...
            <div id="conteneur_menuhaut">
                  ...
                  <select onchange="location.href=this.value">
                      <option value="../controller/controller_selection_administrateur_fr.php?id=<?php error_reporting(0); echo $idUtilisateur?>">Français</option>
                      <option value="../controller/controller_selection_administrateur_en.php?id=<?php error_reporting(0); echo $idUtilisateur?>">English</option>
                  </select>

            <!-- Titre de la page -->
                  <h3>Manager wanted</h3>
                 ...
                 <div id="headerprofile">
                    ...
                    <div class="headername">
                      ...
                      <h5> <a class="deconnexion" href="../controller/deconnexion.php">Logout</a></h5>
                    </div>
                <div >
          ...
          <div  class="pagetitle">
            ...
            <div class="pagetitletext">
              <h1> <span style="color: #5F5DFE"><?php echo $prenomG;?> <?php echo $nomG ?></span> </h1>
              <h6>Find all of his information here</h6>
            </div>
            ...
            <div class="Informations">
                    ...
                    <h2> First name: <span class=profil_info ><?php echo $prenomG ?> </span></h2> 
                    
                    <h2> Name: <span class=profil_info ><?php echo $nomG ?></span></h2> 
                    
                    <h2> Date of birth: <span class=profil_info ><?php echo $birthdayG ?></span> </h2> 
                    
                    <h2> Company name: <span class=profil_info ><?php echo $entrepriseG ?> </span></h2> 
                    
                    <h2> Email: <span class=profil_info ><?php echo $emailG ?></span></h2> 
                    
                    <h2> Poste: <span class=profil_info ><?php echo ucwords($statutG) ?></span> </h2> 
                    
                    </div>

                    <div class="Informations">
                        <div>
                        <img src='<?php echo '../view/public/images/'.$photoG."'"?>' ><br/>

                      <input type='button' class='boutonprofilbis' 
                      onclick="window.location.href='../controller/controller_gestion_administrateur_fr.php?id=<?= $idUtilisateurG ?>'" 
