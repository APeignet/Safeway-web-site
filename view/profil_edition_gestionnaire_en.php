			...
			<div id="menu">
  			...
  			<div id="page_principale">
                        ...
                        <div class="langue">
                            <form>
                                <select onchange="location.href=this.value">
                                    ...
                                    <option value="../controller/controller_edition_profil_fr.php">Francais</option>
                                </select>
                            </form>
                        </div>
        		...
        		<div class="conteneur_principal">
          			...
          			<div  class="pagetitle">
            			...
            			<div class="pagetitletext">
							<h1>
              				...
              				<h6><?php echo ucwords($statut_en) ;?></h6>
					...
					<form name="edition_profil" enctype="multipart/form-data" method="post" action="../controller/controller_edition_profil_en.php" onsubmit="return editProfil('anglais')">
						<p>
							<input onkeyup="erreurPrenomEditionProfil('anglais')" id="prenom" type="text" name="prenom" placeholder="First name" value = "<?php echo $prenom?>" class="formulaire" required/>
							<input onkeyup="erreurNomEditionProfil('anglais')" id="nom" type="text" name="nom" placeholder="Last name" value = "<?php echo $nom?>"class="formulaire" required />
							</br>
							<input onkeyup="erreurBirthdayEditionProfil('anglais')" id="birthday" type="text" class="formulaire"  name="birthday" placeholder="Birthday (yyyy-mm-dd)" value = "<?php echo $birthday?>"  required/>
							<input onkeyup="erreurEntrepriseEditionProfil('anglais')" id="entreprise" readonly="readonly"  type="text" name="entreprise" placeholder="Company name" value = "<?php echo $entreprise?>"class="formulaire" required />
							</br>
							<input type="file" id="hiddenfile" style="display:none" name="file" onchange="getvalue();"/>
							<input type="text" id="selectedfile" name='lienphoto' placeholder="Select a new profile picture"/>
							<input type="button" value="Choose" id="choisir" onclick="getfile();"/>
							<br/>
							<a  class="Modif" href="../controller/controller_modif_mdp_en.php">Click here to reset your password.</a> 
							</br>
							...
							<input type="submit" name="action" value="Update my profile" class="bouton" />
