                        ...
                        <form action="" method="post">
                            <p>
                                    ...
                                    <div class="conteneur1">
                                        ...
                                        <div class="conteneur_contact1">
												<select name="issue" id="issue">
                                                    ...
                                                    <option value = "Mes résultats ne s'affichent pas">My test results aren't showing</option>
                                                    <option value = "Mes résultats sont faux">My test results aren't mine</option>
                                ...
                                <div class="conteneur_message">
                                    <textarea name="message" id="grosformulaire" placeholder="Please share us more details in this section" rows="7" cols="50"></textarea>
                                </div> 
