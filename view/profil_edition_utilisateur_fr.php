        		...
        		<div class="conteneur_principal">
					...
					<form name="edition_profil" enctype="multipart/form-data" method="post" action="../controller/controller_edition_profil_fr.php" onsubmit="return editProfil('francais')">
							<p>
                                ...
                                <input onkeyup="erreurEntrepriseEditionProfil('francais')" id="entreprise" type="text" readonly="readonly"  name="entreprise" placeholder="Entreprise" value = "<?php echo $entreprise?>"class="formulaire" required />
                                </br>
