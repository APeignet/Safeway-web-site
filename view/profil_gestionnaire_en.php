            ...
            <div class="pagetitletext">
              ...
              <h6>Find all of your information here</h6>
                ...
                <div class="profil">
                    ...
                    <h2> First name: <span class=profil_info ><?php echo $prenom ?> </span></h2> 
                    
                    <h2> Name: <span class=profil_info ><?php echo $nom ?></span></h2> 
                    
                    <h2> Date of birth: <span class=profil_info ><?php echo $birthday ?></span> </h2> 
                    
                    <h2> Company name: <span class=profil_info ><?php echo $entreprise ?> </span></h2> 
                    
                    <h2> Email: <span class=profil_info ><?php echo $email ?></span></h2> 
                    
                    <h2> Position: <span class=profil_info ><?php echo ucwords($statut_fr) ?></span> </h2> 
				</div>
