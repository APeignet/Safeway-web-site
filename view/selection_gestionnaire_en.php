        ...
        <div class="conteneur_principal">
          ...
          <div class="pagetitle">
            <div class="pagetitletext">
              ...
              <h6>Driver n°<?php echo $idUtilisateur; ?></h6>
            </div>
            <div class="photodriver">
                        <img src='<?php error_reporting(0);echo '../view/public/images/'.$photoD."'"?>' >
            </div>
            <form action='../model/model_info_conducteur.php'  method='post'>
                      <input type='button' class='bouton' 
                      onclick="window.location.href='../controller/controller_gestion_gestionnaire_en.php?id=<?= $idUtilisateurD ?>'" 
