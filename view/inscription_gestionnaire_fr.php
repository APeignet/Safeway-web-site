					...
					<div class="page_right">
						<div  class="pagetitlebis">
							<div class="pagetitletext">
								...
								<h1 class="titre">Ajout gestionnaire</h1>
								<h2 class="description">Veuillez remplir le formulaire ci-dessous pour ajouter un gestionnaire sur le site de <span class="safecare">Safecare</span>.</h2>
						...
						<form name="inscription_gestionnaire" enctype="multipart/form-data" method="post" action="../controller/controller_inscription_fr.php" onsubmit="return inscriptionValidation('gestionnaire','francais','gestionnaire')">
							<p>
							
								<input onkeyup="erreurPrenom('gestionnaire','francais')" id="prenom" type="text" name="prenom" placeholder="Prénom*" class="formulaire" id="prenom" required/>
								<input onkeyup="erreurNom('gestionnaire','francais')" id="nom" type="text" name="nom" placeholder="Nom*" class="formulaire" id="nom" required />
								<span class="error" id="error_prenom"></span>
								<span class="error" id="error_nom"></span>
								</br>
								<input onkeyup="erreurBirthday('gestionnaire','francais')" id="birthday" type="text" class="formulaire"  name="birthday" placeholder="Naissance (aaaa-mm-jj)*" id="birthday" required/>
                                <input onkeyup="erreurEntreprise('gestionnaire','francais')" id="entreprise" type="text" name="entreprise" placeholder="Nom de l'entreprise*" class="formulaire" id="entreprise" required />
                                <span class="error" id="error_birthday"></span>
								<span class="error" id="error_entreprise"></span>
								</br>								
								<input onkeyup="erreurEmail('gestionnaire','francais')" id="email" type="email" name="email" placeholder="Email*" class="formulaire" id="email" required />
								<input onkeyup="erreurEmail('gestionnaire','francais')" id="emailbis" type="email" name="emailbis" placeholder="Confirmer email*" class="formulaire" id="emailbis" required />
								<span class="error" id="error_email"></span>
								<span class="error" id="error_emailbis"></span>
								</br>								
								<input onkeyup="erreurPassword('gestionnaire','francais')" id="mdp" type="password" name="mdp" placeholder="Mot de passe**" class="formulaire" id="mdp" required />
								<input onkeyup="erreurPassword('gestionnaire','francais')" id="mdpbis" type="password" name="mdpbis" placeholder="Confirmer mot de passe*" class="formulaire" id="mdpbis" required />								
								</br>
