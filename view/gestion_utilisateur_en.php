<html>
	<head>
		...
		<link rel="stylesheet" href="../view/public/css/profil.css" />
		...
		<div id="pages">
			...
			<div id="menu">
  				...
  				<!-- Logo accueil -->
				<a href ="../controller/controller_accueil_utilisateur_en.php" style="text-decoration: none">
...
<div class="bas-menu">
    ...
    <a href="../controller/controller_cgu_en.php">GTU</a>
  		...
  		<div id="page_principale">
    		...
    		<header id="menu_haut">
	            ...
	            <select onchange="location.href=this.value">
								<form>
									<option value="../controller/controller_gestion_utilisateur_en.php">English</option>
	              	<option value="../controller/controller_gestion_utilisateur_fr.php">Français</option>
								</form>
	            </select>
        ...
        <div class="conteneur_principal">
          ...
          <!-- 1er élément de la flexbox : image ou texte
          <div class="element_principal">
          </div>-->

          <!-- 2ème élément de la flexbox : image ou texte
          <div class="element_principal">
          </div>-->

          <div class="pagetitle">
            <div class="pagetitletext">
              <h1>Hello, <span style="color: #5F5DFE"><?php echo $prenom; echo ' '; echo $nom; ?></span></h1>
              <h6>Find your results here</h6>
            </div>
            <div class="pagetitleimage">
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="413.111" viewBox="0 0 413.111 332.703">
                <defs>
            ...
            <div class="result-container">
              ...
              <div class="result">
                <div class="result-element">
                  ...
                  <h4>Total Mark</h4>
                  <div class="mark">
                    <h3><?php error_reporting(0); echo $Score;?>/4</h3>
                  </div>
                </div>
                <div class="result-element">
                  <div class="iconresult">
                  ...
                  <h5>Heart</h5>
                  <h3><?php error_reporting(0); echo $valeurC;?></h3>
                </div>
                <div class="result-element">
                  <div class="iconresult">
                    <svg xmlns="http://www.w3.org/2000/svg" width="72" height="72" viewBox="0 0 72 72">
                  ...
                  <h5>Temperature</h5>
                  <h3><?php error_reporting(0); echo $valeurT;?></h3>
                </div>
                <div class="result-element">
                  <div class="iconresult">
                    <svg xmlns="http://www.w3.org/2000/svg" width="72" height="72" viewBox="0 0 72 72">
                  ...
                  <h5>Vision</h5>
                  <h3><?php error_reporting(0); echo $valeurV;?></h3>
                </div>
                <div class="result-elementBouton">              
                  <a href="../model/integration.php">View my latest results</a>
                </div>
                <div class="result-element">
                  <div class="iconresult">
                    <svg xmlns="http://www.w3.org/2000/svg" width="72" height="72" viewBox="0 0 72 72">
                  ...
                  <h5>Reflex</h5>
                  <h3><?php error_reporting(0); echo $valeurR;?></h3>
                </div>
	    ...
	    let massPopChart = new Chart(myChart, {
	      type:'line',//bar,horizontalBar,pie,line,doughnut,radar,polarArea
	        ...
	        datasets:[
	          ...
	          data:[65, 76, 72, 83, 66],
						label: 'Coeur',
						backgroundColor:'rgba(95, 93, 254, 0.15)',
	          borderColor:'rgba(95, 93, 254, 0.8)',
	          borderWidth:3,
						tension: 0.3,
						fill:true
					},
	          ...
	          data:[27, 27, 28, 26, 27],
						label: 'Temperature',
						backgroundColor:'rgba(95, 93, 254, 0.15)',
	          borderColor:'rgba(95, 93, 254, 0.6)',
	          borderWidth:3,
						tension: 0.3,
						fill:true
					},
	          ...
	          data:[15, 12, 17, 14, 16],
						label: 'Vision',
						backgroundColor:'rgba(95, 93, 254, 0.15)',
	          borderColor:'rgba(95, 93, 254, 0.4)',
	          borderWidth:3,
						tension: 0.3,
						fill:true
					},
						{
	          data:[127, 154, 102, 140, 124],
						label: 'Reflex',
						backgroundColor:'rgba(95, 93, 254, 0.15)',
	          borderColor:'rgba(95, 93, 254, 1)',
	          borderWidth:3,
						tension: 0.3,
						fill:true
						}
