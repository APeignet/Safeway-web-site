    ...
    <a href="../controller/controller_cgu_en.php">GTU</a>
  		...
  		<div id="page_principale">
    		...
    		<div id="menu_haut">
                ...
                <form>
                    <select onchange="location.href=this.value">
                        ...
                        <option value="../controller/controller_gestion_gestionnaire_fr.php">Francais</option>
                    </select>
                </form>
            </div>
            ...
            <div class="pagetitletext">
              <h1>Hello,<span style="color: #5F5DFE"> <?php echo $prenom.' '.$nom; ?></span></h1>
              <h6>Find here all the results of the drivers</h6>
           	</div>
                ...
                <h2>Choose a Driver<a href="../controller/controller_inscription_en.php" class="boutonajouter">Add driver</a> </h2> </h2>
                ...
                <div>
                  ...
                  <?php
							...
							<form method="GET">
								<input type="search" name="q" placeholder="Research..." />
                      ...
                      onclick="window.location.href='../controller/controller_selection_gestionnaire_en.php?id=<?= $a['idUtilisateur'] ?>'" 
                      value='<?= $a['nom'] ?>'/>
								<?php } ?>
								</ul>
							<?php } else { ?>
              ...
              <tr>
                ...
                <div class="driver">
                  ...
                  <div class="driver-element">
                      ...
                      onclick="window.location.href='../controller/controller_selection_gestionnaire_en.php?id=<?= $user['idUtilisateur'] ?>'" 
                      value='View Profile'/> 
                      </form>
