  			...
  			<div id="page_principale">
        		...
        		<div class="conteneur_principal_double">
					...
					<div class="page_right">
                        ...
                        <p>Pour contacter <span>Safeway for Infinite Measures</span>, veuillez-nous<br/>
                              envoyer un mail en renseignant toutes les informations requises :
                        </p>
        
                        <form action="" method="post">
                            <p>
                                <!-- Boîte contenant les 4 formulaires -->
                                <div class="conteneur_contact">
        
                                    <!-- Boîtes prénom et problème -->
                                    <div class="conteneur1">
                                        <div class="conteneur_contact1">
                                            <input type="text" name="prenom" placeholder="Prénom" value = "<?php echo $prenom?>" class="formulaire"  required/>
                                        </div>
                                        </br>
                                        <div class="conteneur_contact1">
												<select name="issue" id="issue">
                                                    <option value = "Mon profil contient des informations erronnées">Mon profil contient des informations erronnées</option>
                                                    <option value = "Mes résultats ne s'affichent pas">Mes résultats ne s'affichent pas</option>
                                                    <option value = "Mes résultats sont faux">Mes résultats sont faux</option>
                                    ...
                                    <div class="conteneur2">
                                        <div class="conteneur_contact2">
                                            <input type="text" name="name" placeholder="Nom" value = "<?php echo $nom?>"class="formulaire" required/> 
                                        </div>
                                    </br>
                                        <div class="conteneur_contact2">  
                                ...
                                <div class="conteneur_message">
                                    <textarea name="message" id="grosformulaire" placeholder="Veuillez apporter plus de précision ici" rows="7" cols="50"></textarea>
                                </div> 
