			...
			<div id="menu">
        		...
        		<div class="conteneur-menu">
    				...
    				<nav>
    					...
    					<div class="element_menu">
              				<a href="../controller/controller_cgu_en.php">
                				<div class="menuicon">
  			...
  			<div id="page_principale">
        		...
        		<div class="conteneur_principal">
					...
					<!-- Rectangle blanc (titre page) -->
          			<div  class="pagetitle">
            			<div class="pagetitletext">
              				<h1>GTU edition</h1>
              				<h6>Complete the forms below to add or edit articles from the <a href="../controller/controller_cgu_en.php" class="lien_titre">GTU</a>. </h6>
           				</div>
					...
					<div class="conteneur_double">
						<div class="conteneur_left">
							<div class="sous_conteneur_left">
								<h3 class="titre">Add a GTU</h3>
								<form method="post" action="../controller/controller_cgu_edition_en.php">
									<p>
										<input type="number" name="numero_ajout"  placeholder="Article number*" class="formulaire" min="1" required/>
										</br>
										<label class="label_cgu">* If an article already has this number, it will have the number n + 1.</label>
									</p>
									<p>							
										<textarea onkeyup="erreurDetailAjoutCgu('anglais')" id="detail_ajout" name="detail_ajout" class="formulaire" placeholder="Write the ARTICLE here." rows="2" cols="60" required></textarea>
										</br>
										<span class="error" id="error_detail_ajout"></span>
									</p>
									
									<p>	
										<input type="submit" name="action" value="Add" class="bouton" />
									</p>
								</form>
							</div>
						</div>
						<div class="conteneur_right">
							<div class="sous_conteneur_right">
								<h3 class="titre">Edit a GTU</h3>
								<form method="post" action="../controller/controller_cgu_edition_en.php">
									<p>
										<input type="number" name="numero_edition"  placeholder="Current article number" class="formulaire" min="1" required/>
										<input type="number" name="numero_editionbis"  placeholder="New article number*" class="formulaire" min="1" required/>
										</br>
										<label class="label_cgu">* If an article already has this number, it will have the number n + 1.</label>
									</p>
									<p>							
										<textarea onkeyup="erreurDetailEditionCgu('anglais')" id="detail_edition" name="detail_edition" class="formulaire" placeholder="Write the ARTICLE here." rows="2" cols="60" required></textarea>
										</br>
										<span class="error" id="error_detail_edition"></span>
									</p>
									
									<p>	
										<input type="submit" name="action" value="Edit" class="bouton" />
									</p>
								</form>
							</div>
						</div>
					...
					<div class="conteneur_doublebis">
						<div class="ancrecgu">
							<a href=#sous_conteneur_leftbis class="liencgu">Add a GTU</a>
							<a href=#sous_conteneur_rightbis class="liencgu">Edit a GTU</a>
						</div>
						<div class="conteneur_leftbis">
							<div id="sous_conteneur_leftbis">
								...
								<form method="post" action="../controller/controller_cgu_edition_en.php">
									...
									<p>							
										<textarea onkeyup="erreurDetailAjoutCgu('anglais')" id="detail_ajout2" name="detail_ajout2" class="formulaire" placeholder="Write the ARTICLE here." rows="2" cols="60" required></textarea>
										</br>
						...
						<div class="conteneur_rightbis">
							<div id="sous_conteneur_rightbis">
								...
								<form method="post" action="../controller/controller_cgu_edition_en.php">
									...
									<p>							
										<textarea onkeyup="erreurDetailEditionCgu('anglais')" id="detail_edition2" name="detail_edition2" class="formulaire" placeholder="Write the ARTICLE here." rows="2" cols="60" required></textarea>
										</br>
