          ...
          <!-- Rectangle blanc (titre page) -->
            ...
            <!-- Texte rectangle blanc -->
                  <div class="pagetitletext">
                      <h1> Faites votre <span style="color: #5F5DFE"> choix</span> </h1>
                      <h6> Vous trouverez ci-dessous toutes les accessibilités de votre compte administrateur.</h6>
                  </div>
                ...
                <div class="gestionnaire">
                  <div class="gestionnaire-element">
                    ...
                    <svg style="margin-bottom:-17px" xmlns="http://www.w3.org/2000/svg" width="120" height="120" viewBox="0 0 33.5 24">
                      ...
                      <h4> Ajouter un <br/> gestionaire</h4>

                      <button onclick="window.location.href = '../controller/controller_inscription_fr.php';">Cliquez Ici</button>
                  ...
                  <div class="gestionnaire-element">
                      ...
                      <h4> Chercher un <br/> gestionnaire</h4>
                      <?php
              ...
              <?php } }?>
                  ...
                  <div class="gestionnaire-element">
                    <svg style="margin-bottom:-10px; margin-top: 5px;" xmlns="http://www.w3.org/2000/svg" width="105" height="105" viewBox="0 0 33.182 33.182">
                      ...
                      <button onclick="window.location.href = '../controller/controller_faq_edition_fr.php';">Cliquez Ici</button>
                  </div>
                  <div class="gestionnaire-element">
                    ...
                    <svg style="margin-bottom:-10px; margin-top: 5px;" xmlns="http://www.w3.org/2000/svg" width="105" height="105" viewBox="0 0 33.182 33.182">
                      ...
                      <h4> Modifier la CGU</h4>

                      <button onclick="window.location.href = '../controller/controller_cgu_edition_fr.php';">Cliquez ici</button>
