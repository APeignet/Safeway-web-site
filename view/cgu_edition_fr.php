...
<html>
	<head>
		<meta charset="utf-8" />
		<link rel="stylesheet" href="../view/public/css/cgu_edition.css" />
		<link rel="stylesheet" href="../view/public/css/template.css" />
		<link rel="icon" type="image/svg" href="../view/public/images/Logo1001.svg" />
		<script src="../view/public/javascript/cgu_edition.js"></script>
		<title>Editer les CGU</title>
	</head>
  			...
  			<div id="page_principale">
    			...
    			<header id="menu_haut">
    				...
    				<div id="conteneur_menuhaut">
            			...
            			<select onchange="location.href=this.value">
              				<option value="../controller/controller_cgu_edition_fr.php">Français</option>
              				<option value="../controller/controller_cgu_edition_en.php">English</option>
            			</select>
        		...
        		<div class="conteneur_principal">
					...
					<!-- Rectangle blanc (titre page) -->
          			<div  class="pagetitle">
            			<div class="pagetitletext">
              				<h1>Edition CGU</h1>
              				<h6>Remplissez les formulaires ci-dessous pour ajouter ou modifier des articles <a href="../controller/controller_cgu_fr.php" class="lien_titre">CGU</a>. </h6>
           				</div>
					...
					<div class="conteneur_double">
						<div class="conteneur_left">
							<div class="sous_conteneur_left">
								<h3 class="titre">Ajouter une CGU</h3>
								<form name="ajout_cgu" method="post" action="../controller/controller_cgu_edition_fr.php" onsubmit="return ajoutCgu('francais')">
									<p>
										<input type="number" name="numero_ajout"  placeholder="N°article*" class="formulaire" min="1" required/>
										</br>
										<label class="label_cgu">* Si un article possède déjà ce numéro, il aura comme numéro n+1.</label>
									</p>
									<p>							
										<textarea onkeyup="erreurDetailAjoutCgu('francais')" id="detail_ajout" name="detail_ajout" class="formulaire" placeholder="Ecrire l'ARTICLE ici." rows="2" cols="60" required></textarea>
										</br>
										<span class="error" id="error_detail_ajout"></span>
									</p>
						...
						<div class="conteneur_right">
							<div class="sous_conteneur_right">
								<h3 class="titre">Modifier une CGU</h3>
								<form  name="edition_cgu" method="post" action="../controller/controller_cgu_edition_fr.php" onsubmit="return editionCgu('francais')">
									<p>
										<input type="number" name="numero_edition"  placeholder="N°article actuel" class="formulaire" min="1" required/>
										<input type="number" name="numero_editionbis"  placeholder="Nouveau n°article*" class="formulaire" min="1" required/>
										</br>
										<label class="label_cgu">* Si un article possède déjà ce numéro, il aura comme numéro n+1.</label>
									</p>
									<p>							
										<textarea onkeyup="erreurDetailEditionCgu('francais')" id="detail_edition" name="detail_edition" class="formulaire" placeholder="Ecrire l'ARTICLE ici." rows="2" cols="60" required></textarea>
										</br>
										<span class="error" id="error_detail_edition"></span>
									</p>
					...
					<div class="conteneur_doublebis">
						<div class="ancrecgu">
							<a href=#sous_conteneur_leftbis class="liencgu">Ajouter une CGU</a>
							<a href=#sous_conteneur_rightbis class="liencgu">Modifier une CGU</a>
						</div>
						<div class="conteneur_leftbis">
							<div id="sous_conteneur_leftbis">
								<h3 class="titre">Ajouter une CGU</h3>
								<form name="ajout_cgu2" method="post" action="../controller/controller_cgu_edition_fr.php" onsubmit="return ajoutCgu('francais')">
									<p>
										<input type="number" name="numero_ajout2"  placeholder="N°article*" class="formulaire" min="1" required/>
										</br>
										<label class="label_cgu">* Si un article possède déjà ce numéro, il aura comme numéro n+1.</label>
									</p>
									<p>							
										<textarea onkeyup="erreurDetailAjoutCgu('francais')" id="detail_ajout2" name="detail_ajout2" class="formulaire" placeholder="Ecrire l'ARTICLE ici." rows="2" cols="60" required></textarea>
										</br>
										<span class="error" id="error_detail_ajout2"></span>
									</p>
						...
						<div class="conteneur_rightbis">
							<div id="sous_conteneur_rightbis">
								...
								<form  name="edition_cgu" method="post" action="../controller/controller_cgu_edition_fr.php" onsubmit="return editionCgu('francais')">
									<p>
										<input type="number" name="numero_edition2"  placeholder="N°article actuel" class="formulaire" min="1" required/>
										<input type="number" name="numero_editionbis2"  placeholder="Nouveau n°article*" class="formulaire" min="1" required/>
										</br>
										<label class="label_cgu">* Si un article possède déjà ce numéro, il aura comme numéro n+1.</label>
									</p>
									<p>							
										<textarea onkeyup="erreurDetailEditionCgu('francais')" id="detail_edition2" name="detail_edition2" class="formulaire" placeholder="Ecrire l'ARTICLE ici." rows="2" cols="60" required></textarea>
										</br>
										<span class="error" id="error_detail_edition2"></span>
									</p>
