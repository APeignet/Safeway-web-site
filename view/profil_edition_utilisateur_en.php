		...
		<div id="pages">
			...
			<div id="menu">
        		...
        		<div class="bas-menu">
          			...
          			<a href="../view/cgu_utilisateur_en.php">GTU</a>
        		</div>
        		...
        		<div class="conteneur_principal">
					...
					<form name="edition_profil" enctype="multipart/form-data" method="post" action="../controller/controller_edition_profil_en.php" onsubmit="return editProfil('anglais')">
						<p>
							...
							<input onkeyup="erreurEntrepriseEditionProfil('anglais')" id="entreprise" type="text" readonly="readonly" name="entreprise" placeholder="Company name" value = "<?php echo $entreprise?>"class="formulaire" required />
							</br>
