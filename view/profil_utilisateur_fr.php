              ...
              <h6>Retrouvez ici l'ensemble de vos informations</h6>
                ...
                <div class="profil">
		  			...
		  			<div class="Informations">
							<h2> Prénom : <?php echo $prenom ?> </h2>
							<h2> Nom : <?php echo $nom ?> </h2>
							<h2> Date de naissance : <?php echo $birthday ?> </h2>
							<h2> Nom de l'entreprise : <?php echo $entreprise ?> </h2>
							<h2> Email : <?php echo $email ?> </h2>
							<h2> Poste : <?php echo ucwords($statut_fr) ?> </h2>
            </div>
