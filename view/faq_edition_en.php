				...
				<a href ="../controller/controller_accueil_en.php" style="text-decoration: none">
					<svg xmlns="http://www.w3.org/2000/svg" width="206.78" height="40.978" viewBox="0 0 215.78 40.978" class="menulogo">
						<g id="Group_373" data-name="Group 373" transform="translate(30.839 -4.64)">
							<text id="SAFECARE" transform="translate(97.941 34.136)" fill="#fff" font-size="27" font-weight="700" letter-spacing="0.09em"><tspan x="-77.868" y="0">SAFECARE</tspan></text>
  			...
  			<div id="page_principale">
        		...
        		<div class="conteneur_principal">
					...
					<!-- Rectangle blanc (titre page) -->
          			<div  class="pagetitle">
            			<div class="pagetitletext">
              				<h1>FAQ edition</h1>
              				<h6>Complete the forms below to add or edit questions and answers to the page <a href="../controller/controller_faq_en.php" class="lien_titre">FAQ</a>. </h6>
           				</div>
					...
					<div class="conteneur_double">
						<div class="conteneur_left">
							<div class="sous_conteneur_left">
								<h3 class="titre">Add a FAQ</h3>
								<form name="ajout_faq" method="post" action="../controller/controller_faq_edition_en.php" onsubmit="return ajoutFaq('anglais')">
									<p>
										<input type="number" name="numero_ajout"  placeholder="Question number*" class="formulaire" min="1" required/>
										</br>
										<label class="label_faq">* If a question already has this number, it will have the number n+1.</label>
									</p>
									<p>							
										<textarea onkeyup="erreurQuestionAjoutFaq('anglais')" id="question_ajout" name="question_ajout" class="formulaire" placeholder="Write the QUESTION here." rows="2" cols="60" required></textarea>
									</p>
									<p>						
										<textarea onkeyup="erreurReponseAjoutFaq('anglais')" id="reponse_ajout" name="reponse_ajout" class="formulaire" placeholder="Write the ANSWER here." rows="2" cols="60" required></textarea>
										</br>
									...
									<p>	
										<input type="submit" name="ajout" value="Add" class="bouton" />
									</p>
								</form>
							</div>
						</div>
						<div class="conteneur_right">
							<div class="sous_conteneur_right">
								<h3 class="titre">Edit a FAQ</h3>
								<form name="edition_faq" method="post" action="../controller/controller_faq_edition_en.php" onsubmit="return editionFaq('anglais')">
									<p>
										<input type="number" name="numero_edition"  placeholder="Current question number" class="formulaire" min="1" required/>
										<input type="number" name="numero_editionbis"  placeholder="New question number*" class="formulaire" min="1" required/>
										</br>
										<label class="label_faq">* If a question already has this number, it will have the number n+1.</label>
									</p>
									<p>							
										<textarea onkeyup="erreurQuestionEditionFaq('anglais')" id="question_edition" name="question_edition" class="formulaire" placeholder="Write the QUESTION here." rows="2" cols="60" required></textarea>
									</p>
									<p>						
										<textarea onkeyup="erreurReponseEditionFaq('anglais')" id="reponse_edition" name="reponse_edition" class="formulaire" placeholder="Write the ANSWER here." rows="2" cols="60" required></textarea>
										</br>
										<span class="error" id="error_question_edition"></span>
										<span class="error" id="error_reponse_edition"></span>
									</p>
									<p>	
										<input type="submit" name="edition" value="Edit" class="bouton" />
									</p>
								</form>
							</div>
						</div>
					...
					<div class="conteneur_doublebis">
						<div class="ancrefaq">
							<a href=#sous_conteneur_leftbis class="lienfaq">Add a FAQ</a>
							<a href=#sous_conteneur_rightbis class="lienfaq">Edit a FAQ</a>
						</div>
						<div class="conteneur_leftbis">
							<div id="sous_conteneur_leftbis">
								<h3 class="titre">Add a FAQ</h3>
								<form name="ajout_faq2" method="post" action="../controller/controller_faq_edition_en.php" onsubmit="return ajoutFaq('anglais')">
									<p>
										<input type="number" name="numero_ajout2"  placeholder="Question number*" class="formulaire" min="1" required/>
										</br>
										<label class="label_faq">* If a question already has this number, it will have the number n+1.</label>
									</p>
									<p>							
										<textarea onkeyup="erreurQuestionAjoutFaq('anglais')" id="question_ajout2" name="question_ajout2" class="formulaire" placeholder="Write the QUESTION here." rows="2" cols="60" required></textarea>
									</p>
									<p>						
										<textarea onkeyup="erreurReponseAjoutFaq('anglais')" id="reponse_ajout2" name="reponse_ajout2" class="formulaire" placeholder="Write the ANSWER here." rows="2" cols="60" required></textarea>
										</br>
										<span class="error" id="error_question_ajout2"></span>
										<span class="error" id="error_reponse_ajout2"></span>
									</p>
									<p>	
										<input type="submit" name="ajout2" value="Add" class="bouton" />
									</p>
								</form>
							</div>
						</div>
						<div class="conteneur_rightbis">
							<div id="sous_conteneur_rightbis">
								<h3 class="titre">Edit a FAQ</h3>
								<form name="edition_faq2" method="post" action="../controller/controller_faq_edition_en.php" onsubmit="return editionFaq('anglais')">
									<p>
										<input type="number" name="numero_edition2"  placeholder="Current question number" class="formulaire" min="1" required/>
										<input type="number" name="numero_editionbis2"  placeholder="New question number*" class="formulaire" min="1" required/>
										</br>
										<label class="label_faq">* If a question already has this number, it will have the number n+1.</label>
									</p>
									<p>							
										<textarea onkeyup="erreurQuestionEditionFaq('anglais')" id="question_edition2" name="question_edition2" class="formulaire" placeholder="Write the QUESTION here." rows="2" cols="60" required></textarea>
									</p>
									<p>						
										<textarea onkeyup="erreurReponseEditionFaq('anglais')" id="reponse_edition2" name="reponse_edition2" class="formulaire" placeholder="Write the ANSWER here." rows="2" cols="60" required></textarea>
										</br>
										<span class="error" id="error_question_edition2"></span>
										<span class="error" id="error_reponse_edition2"></span>
									</p>
									<p>	
										<input type="submit"  name="edition2" value="Edit" class="bouton" />
									</p>
								</form>
							</div>
						</div>
