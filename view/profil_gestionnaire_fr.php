		...
		<div id="pages">
  		...
  		<div id="page_principale">
            ...
            <div class="pagetitletext">
              <h1> <span style="color: #5F5DFE"> Mon profil</span> </h1>
              <h6>Retrouvez ici l'ensemble de vos informations</h6>
           	</div>
                ...
                <div class="profil">
                    ...
                    <h2> Prénom : <span class=profil_info ><?php echo $prenom ?> </span></h2> 
                    
                    <h2> Nom : <span class=profil_info ><?php echo $nom ?></span></h2> 
                    
                    <h2> Date de naissance : <span class=profil_info ><?php echo $birthday ?></span> </h2> 
                    
                    <h2> Nom de l'entreprise : <span class=profil_info ><?php echo $entreprise ?> </span></h2> 
                    
                    <h2> Email : <span class=profil_info ><?php echo $email ?></span></h2> 
                    
                    <h2> Poste : <span class=profil_info ><?php echo ucwords($statut_fr) ?></span> </h2> 
                    ...
                    <div class="Informations">
						...
						<a href="../controller/controller_edition_profil_fr.php" class="boutonprofil">Modifier le profil</a>
                    	</div>
                	</div>
</div>
