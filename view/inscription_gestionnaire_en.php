					...
					<div class="page_right">
						<div  class="pagetitlebis">
							<div class="pagetitletext">
								...
								<h1 class="titre">Add a manager</h1>
								<h2 class="description">Please fill out the form below to add a manager to <span class="safecare">Safecare</span>'s web site.</h2>
						...
						<form name="inscription_gestionnaire" enctype="multipart/form-data"  method="post" action="../controller/controller_inscription_en.php" onsubmit="return inscriptionValidation('gestionnaire','anglais','manager')">
							<p>
							
								<input onkeyup="erreurPrenom('gestionnaire','anglais')" id="prenom" type="text" name="prenom" placeholder="First name*" class="formulaire" id="prenom" required/>
								<input onkeyup="erreurNom('gestionnaire','anglais')" id="nom" type="text" name="nom" placeholder="Last name*" class="formulaire"  id="nom" required />
								<span class="error" id="error_prenom"></span>
								<span class="error" id="error_nom"></span>
								</br>
								<input onkeyup="erreurBirthday('gestionnaire','anglais')" id="birthday" type="text" class="formulaire"  name="birthday" placeholder="Birthday (yyyy-mm-dd)*"  id="birthday" required/>
                                <input onkeyup="erreurEntreprise('gestionnaire','anglais')" id="entreprise" type="text" name="entreprise" placeholder="Company name*" class="formulaire"  id="entreprise" required />
                                <span class="error" id="error_birthday"></span>
								<span class="error" id="error_entreprise"></span>
								</br>
								<input onkeyup="erreurEmail('gestionnaire','anglais')" id="email" type="email" name="email" placeholder="Email*" class="formulaire"  id="email" required />
								<input onkeyup="erreurEmail('gestionnaire','anglais')" id="emailbis" type="email" name="emailbis" placeholder="Confirm email*" class="formulaire"  id="emailbis" required />
								<span class="error" id="error_email"></span>
								<span class="error" id="error_emailbis"></span>
								</br>
								<input onkeyup="erreurPassword('gestionnaire','anglais')" id="mdp" type="password" name="mdp" placeholder="Password**" class="formulaire"  id="mdp" required />
								<input onkeyup="erreurPassword('gestionnaire','anglais')" id="mdpbis" type="password" name="mdpbis" placeholder="Confirm password*" class="formulaire"  id="mdpbis" required />
								</br>
								<label id="passwordlabel">** Use at least eight characters with lowercase and uppercase letters, numbers and symbols.</label>
								...
								<input type="text" id="selectedfile" name='lienphoto' placeholder="Select a new profile picture" required/>
								<input type="button" value="Choose" id="choisir" onclick="getfile();" required/>
								</br>
								<span class="error"><?php error_reporting(0);  echo '<br/>'; echo $alert2;  echo $alert3; echo $alert4; echo $non; ?></span>
