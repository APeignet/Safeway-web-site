...
if(isset($_POST['email']) && isset($_POST['mdp']))
{
    ...
    if($email !== "" && $mdp !== "")
    {
        ...
        if (BonId($bdd, $email, $mdp)) {
            ...
            header('Location: ../controller/controller_redir_accueil_fr.php');
        ...
        {
            $erreur=1;
                require '../view/authentification_fr.php'; // utilisateur ou mot de passe incorrect
        }
    }
    ...
    {
        $erreur=2;
        require '../view/authentification_fr.php'; // utilisateur ou mot de passe vide
    }
}
